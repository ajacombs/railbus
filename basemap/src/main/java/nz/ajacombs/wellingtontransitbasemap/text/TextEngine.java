package nz.ajacombs.wellingtontransitbasemap.text;
...
import nz.ajacombs.wellingtontransitbasemap.names.Script;
...
public class TextEngine {
  ...
  private static int codepointFromGlyph(HashMap<String, Integer> encoding, int index, int xOffset, int yOffset,
    ...
    for (int i = 0; i < deltas.length; ++i) {
      ...
      String glyphKey = FontRegistry.getGlyphKey(index, xOffset + deltaXOffset, yOffset, xAdvance + deltaXAdvance,
          yAdvance);
