...
import static nz.ajacombs.wellingtontransitbasemap.postprocess.LinkSimplify.linkSimplify;
...
import nz.ajacombs.wellingtontransitbasemap.locales.CartographicLocale;
import nz.ajacombs.wellingtontransitbasemap.locales.US;
...
public class Roads implements ForwardingProfile.LayerPostProcesser {
  ...
  public void processOsm(SourceFeature sf, FeatureCollector features) {
    if (sf.canBeLine() && sf.hasTag("highway") &&
      ...
      if (highway.equals("motorway") || highway.equals("motorway_link")) {
        // TODO: (nvkelso 20230622) Use Natural Earth for low zoom roads at zoom 5 and
        // earlier
        // as normally OSM roads would start at 6, but we start at 3 to match Protomaps
        // v2
        kind = "highway";
        minZoom = 3;
        ...
        if (highway.equals("trunk")) {
          // Just trunk earlier zoom, otherwise road network looks choppy just with
          // motorways then
          minZoom = 6;
          minZoomShieldText = 8;
    ...
    if (sf.canBeLine() && (sf.hasTag("railway") ||
        ...
        (!sf.hasTag("railway", "abandoned", "razed", "demolished", "removed", "construction", "platform",
            "proposed"))) {
      ...
      // TODO: (nvkelso 20230623) This should be variable, but 12 is better than 0 for
      // line merging
  ...
  public List<VectorTile.Feature> postProcess(int zoom, List<VectorTile.Feature> items) throws GeometryException {
    // limit the application of LinkSimplify to where cloverleafs are unlikely to be
    // at tile edges.
