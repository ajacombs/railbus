...
import nz.ajacombs.wellingtontransitbasemap.postprocess.Area;
...
public class Landuse implements ForwardingProfile.LayerPostProcesser {
  ...
  public void processOsm(SourceFeature sf, FeatureCollector features) {
    if (sf.canBePolygon() && (sf.hasTag("aeroway", "aerodrome", "runway") ||
        ...
        // TODO: (nvkelso 20230622) This use of the place tag here is dubious, though
        // paired with "residential"
      ...
      // NOTE: (nvkelso 20230622) landuse labels for polygons are found in the pois
      // layer
  ...
  public List<VectorTile.Feature> postProcess(int zoom, List<VectorTile.Feature> items) throws GeometryException {
    ...
    // We only care about park boundaries inside groups of adjacent parks at higher
    // zooms when they are labeled
