...
public class Landcover implements ForwardingProfile.LayerPostProcesser {
  ...
  static final Map<String, Integer> sortKeyMapping = Map.of("barren", 0, "snow", 1, "crop", 2, "shrub", 3, "grass", 4,
      "trees", 5);
  ...
  public void processLandcover(SourceFeature sf, FeatureCollector features) {
    ...
    // polygons are disjoint and non-overlapping, but order them in archive in
    // consistent way
